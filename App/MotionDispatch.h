...
typedef struct
{
	u8 ExecuteCmdValid;     //执行指令有效
	CanMotionDispatchCmd_TypeDef MotionCmd;  //动作指令
...
typedef void (*Z_To_WorkStation_TypeDef)(MotionCmd_TypeDef WorkStation,orUnloadCup_TypeDef orUnloadCup);//Z轴下降到工作位
